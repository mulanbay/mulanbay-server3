...
public class StatTemplateController extends BaseController {
    ...
    public ResultBean userTree(ReportUserTreeSH sf) {
        List<TreeBean> list = this.createNotifyConfigTree(sf.getLevel(),sf.getBussType());
    ...
    public ResultBean tree(ReportTreeSH sf) {
        List<TreeBean> list = this.createNotifyConfigTree(null,sf.getBussType());
        return callback(list);
    }

    private List<TreeBean> createNotifyConfigTree(Integer maxLevel,BussType bussType) {
