...
public class ConsumeSoldDateStat implements DateStat, CalendarDateStat {
    ...
    public ConsumeSoldDateStat(Number indexValue, Long totalCount, BigDecimal totalPrice) {
